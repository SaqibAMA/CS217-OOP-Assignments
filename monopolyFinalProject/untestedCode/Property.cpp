...
Property::Property(char* spaceType, int* playersOnSpace, int playersOnSpaceCount,char* propertyName, char*propertyGroup, int propertyID, int ownnerID, bool mortgaged):Space(spaceType,playersOnSpace,playersOnSpaceCount) {
